...
public:
	...
	afx_msg void OnFilterMin();
	afx_msg void OnFilterMax();
	afx_msg void OnFilterWeightedMedian();
	afx_msg void OnFilterDiffusion();
	afx_msg void OnImageTranslation();
	afx_msg void OnImageResize();
	afx_msg void OnImageRotation90();
	afx_msg void OnImageRotation1800();
	afx_msg void OnImageRotation270();
